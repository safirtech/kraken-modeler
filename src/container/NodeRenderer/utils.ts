...
import SecurableGroupNode from '../../components/Nodes/SecurableGroupNode';
...
export function createNodeTypes(nodeTypes: NodeTypesType): NodeTypesType
{
  const standardTypes: NodeTypesType = {
    ...
    output: wrapNode((nodeTypes.output || OutputNode) as ComponentType<
      NodeComponentProps
    >),
    securable_group: wrapNode((nodeTypes.securable_group || SecurableGroupNode) as ComponentType<
      NodeComponentProps
    >),
  };
